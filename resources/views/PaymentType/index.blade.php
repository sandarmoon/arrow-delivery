    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <a href="{{route('payment_types.create')}}" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus" aria-hidden="true"></i> {{ __("Add New")}}</a>
            ...
            <table class="table dataTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$row->name}}</td>
                  <td>
                    <a href="{{route('payment_types.edit',$row->id)}}" class="btn btn-sm btn-warning">{{ __("Edit")}}</a>
