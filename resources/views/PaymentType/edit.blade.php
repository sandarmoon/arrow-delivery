...
@section('content')
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title d-inline-block">PaymentTypes Edit Form</h3>
          ...
          <form action="{{route('payment_types.update',$paymentType->id)}}" method="POST">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="payment" type="text" placeholder="Enter name" name="name" value="{{$paymentType->name}}">
