    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <a href="{{route('senderoffice.create')}}" class="btn btn-primary float-right"><i class="fa fa-plus" aria-hidden="true"></i> {{ __("Add New")}}</a>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('senderoffice.edit',$row->id)}}" class="btn btn-warning">{{ __("Edit")}}</a>
